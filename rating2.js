...
function executeRating(stars, result) {
   ...
   form.addEventListener('submit', (e) => {
    ...
    switch(starNo){
      ...
      case 1:
        return(list.innerHTML += `<li class="p-2 mt-4 bor-style text-secondary">
        ${todoText}<div class="rate mt-2 case_1">
       <span class="rating__result"></span>
       <i class="rating__star2 fa fa-star"></i>
      ...
      case 2:
        return(list.innerHTML += `<li class="p-2 mt-4 bor-style text-secondary">
        ${todoText}<div class="rate mt-2 case_2">
       <span class="rating__result"></span>
       <i class="rating__star2 fa fa-star"></i>
       <i class="rating__star2 fa fa-star"></i>
       <i class="rating__star fa fa-star"></i>
      ...
      case 4:
        return(list.innerHTML += `<li class="p-2 mt-4 bor-style text-secondary">
        ${todoText}<div class="rate mt-2 case_4">
       <span class="rating__result"></span>
       <i class="rating__star2 fa fa-star"></i>
       <i class="rating__star2 fa fa-star"></i>
       <i class="rating__star2 fa fa-star"></i>
      ...
      default :
        return(list.innerHTML += `<li class="p-2 mt-4 bor-style text-secondary">
        ${todoText}<div class="rate mt-2 case_0">
            <h6>Give some rating</h6>
        <p class="mt-2">${areaText}</p>
      </li>` )
     }
...
//  let buttonClick = document.getElementById('btnSubmit')
